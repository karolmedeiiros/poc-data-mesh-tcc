...
def normalize(odcs: Dict[str, Any]) -> Dict[str, Any]:
    ...
    spec: Dict[str, Any] = {
        ...
        # QoS avançado (Data Observability, Error Budgets, Reliability, Performance).
        # Cada produto declara em seu contrato o baseline federado de QoS a que se
        # compromete; o validador de QoS consome estas seções.
        "observability": top_cp.get("observability", {}) or {},
        "error_budgets": top_cp.get("error_budgets", {}) or {},
        "reliability": top_cp.get("reliability", {}) or {},
        "performance": top_cp.get("performance", {}) or {},
    }
